defmodule SamplePhoenixAppWithPostgresDbWeb.ChannelCase do
  @moduledoc """
  ...
  by setting `use SamplePhoenixAppWithPostgresDbWeb.ChannelCase, async: true`, although
  ...
  using do
    quote do
      ...
      import SamplePhoenixAppWithPostgresDbWeb.ChannelCase
