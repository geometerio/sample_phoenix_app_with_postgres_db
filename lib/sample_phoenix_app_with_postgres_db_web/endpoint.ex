defmodule SamplePhoenixAppWithPostgresDbWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_sample_phoenix_app_with_postgres_db_key",
  ...
  plug Plug.Static,
    at: "/",
    from: :sample_phoenix_app_with_postgres_db,
    gzip: false,
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :sample_phoenix_app_with_postgres_db
  end
